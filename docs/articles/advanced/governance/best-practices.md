...
host an AMA on [Reddit](https://www.reddit.com/r/openverse) or host a Q&A (questions & answers).
...
6. Relationships and disclosures
   - have you received or applied for grants or funding? for similar work?
     (e.g. from the [Evmos Grants Program](https://medium.com/openverse/announcing-evmos-grants-78aa28562db6)
...
2. Background information - promote understanding of the ERC-20 Module
   - a mention of the original [blog post](https://medium.com/openverse/introducing-evmos-erc20-module-f40a61e05273)
     that introduced the ERC-20 Module
   - a brief explanation of what the ERC-20 Module does
   - a mention of the [ERC-20 Module documentation](https://docs.openverse.network/protocol/modules/erc20)
3. Solution - generally how ERC-20 Module changes will be made
   ...
   - ensure the following are both adhered to and documented:
      - the contracts are verified (either through the [EVM explorer](https://evm.openverse.network)
...
1. Post a discussion in the [Commonwealth Evmos community](https://commonwealth.im/openverse).
