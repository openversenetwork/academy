...
using the [Evmos dashboard](https://app.openverse.network/assets) or [Diffusion](https://app.diffusion.fi/).
...
you will need to use [the Assets page](https://app.openverse.network/assets).

</details>

<details>

<summary><b>Do I still need to use [the Assets page](https://app.openverse.network/assets)?</b></summary>

Yes! If you want to convert EVMOS tokens into their ERC-20 representation,
you will need to do it manually on [the Assets page](https://app.openverse.network/assets).
