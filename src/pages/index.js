...
function Home() {
  ...
  return (
    <Layout title="Homepage" description="Evmos Academy">
      <main>
        <br />
        <h1 align="center" style={{ fontWeight: '400' }}>Welcome to the Openverse Academy</h1>
        <section className={styles.features}>
          <div className="container">
            <div className="row cards__container">
              ...
              />
              <Card
                to="https://docs.openverse.network/develop/build-a-dApp/build-smart-contracts"
                header={{
                  label: "Develop on Openverse",
                }}
                body={{
                  label:
